...
const DAILY_ORDER = [
  /* --- 固定段：第 1~20 天，人人相同（改这段=动老用户序列，发链接后只能追加） --- */
  'tip-002', //  1. 你清清楚楚记得的事，可能从没发生过
  'tip-032', //  2. 人只用了 10% 的大脑—一句彻底的谣言
  'tip-046', //  3. 明明吃的是糖，为什么真的没那么疼了
  'tip-007', //  4. 一半人会看不见画面里走过的大猩猩
  'tip-014', //  5. 想记住一个东西，考自己比再读一遍更有用
  'tip-036', //  6. 你学过的马斯洛金字塔，马斯洛本人可能不认账 ·修正
  'cog-006', //  7. 嘈杂聚会里，角落有人提你名字，你为什么会突然听见？ ·认知
  'tip-009', //  8. 在吊桥上遇见的人，为什么更容易让你心动
  'tip-020', //  9. 九成能活和一成会死，会让你做出不同的选择
  'tip-053', // 10. 小猴子宁可饿着，也要抱着那个不产奶的布妈妈
  'tip-018', // 11. 熬夜复习，可能正好删掉了你刚背的东西
  'tip-016', // 12. 你每只眼睛里都有个洞，是大脑帮你补上的
  'tip-001', // 13. 记忆容量是7个—这个流传最广的说法可能是错的
  'tip-029', // 14. 把婴儿放在玻璃悬崖边，他会停下来不敢爬
  'cog-005', // 15. 为什么刚看的电话号码，走两步就忘了？ ·认知
  'tip-013', // 16. 你听到的声音，会被你看到的嘴型改掉
  'tip-055', // 17. 鬼压床不是灵异，是身体醒得比脑子慢
  'tip-040', // 18. 意志力像电量，用一会儿就没了—大型重复实验没能证实 ·修正
  'tip-058', // 19. 丢 100 块的痛，要捡到快 200 块才能扯平
  'tip-030', // 20. 心里乱的时候，把情绪说出名字就能降一档

  /* --- 随机池：第 21 天起，洗牌一次后按 P.tailQueue 持久化，每人不同 --- */
  'tip-005', // 地平线上的月亮显得特别大，其实是错觉
  'tip-023', // 电影已经很难看了，你为什么还硬坐到散场
  'tip-033', // 刚出生的婴儿能分辨全世界的语音，长大反而退化了
  'tip-048', // 他脑子清楚、什么都懂，就是说不出一句完整的话
  'cog-010', // 那些你没听见的话，可能其实都进了脑子 ·认知
  'tip-012', // 星座为什么算得这么准—因为它对谁都准
  'tip-047', // 冰淇淋卖得越多，溺水的人越多—是冰淇淋害的吗
  'tip-003', // 手术治好了他的癫痫，却偷走了他的每一个明天
  'tip-027', // 你闻不到自己身上的香水，别人却闻得清清楚楚
  'tip-060', // 一首歌第一次听没感觉，听多了却越来越上头
  'tip-021', // 你以为自己在找真相，其实只是在找我早就信的东西
  'tip-044', // 我是视觉型学习者—把人这么分类，其实帮不了学习 ·修正
  'tip-050', // 别把一类题刷完再刷下一类—混着来其实记得更牢
  'tip-006', // 理性靠左脑，感性靠右脑是个流行了半世纪的谣言
  'tip-010', // 一个随口报的数字，能悄悄改变你愿意出的价
  'tip-056', // 有人认得出你的声音，却认不出你的脸
  'tip-019', // 你清楚记得重大新闻那天在哪—但很可能记错了
  'tip-041', // 相信自己能变强，成绩就会变好—成长型思维被夸大了 ·修正
  'tip-004', // 话到嘴边却想不起来，到底卡在哪了？
  'tip-054', // 婴儿要多大，才认得出镜子里那个是我
  'tip-022', // 空难新闻看多了你就怕飞，可开车危险得多
  'tip-057', // 盯着红色看半分钟，再看白墙，会浮出一片青绿
  'tip-039', // 好人穿上狱警制服就会变恶魔—这个著名实验，没那么可信 ·修正
  'tip-011', // 想让孩子不爱画画？就开始花钱请他画
  'tip-051', // 先猜一下再看答案，哪怕猜错，也记得更牢
  'tip-028', // 有一种图，你会看见一个根本不存在的白三角
  'tip-059', // 做完的事转头就忘，没做完的却一直挂在心上
  'tip-015', // 听莫扎特让宝宝变聪明被夸大了一大半
  'tip-049', // 人类学语言，好像有一扇会慢慢关上的窗
  'tip-043', // 四岁能忍住不吃棉花糖的孩子长大更成功—其实大半是家境 ·修正
  'tip-035', // 测谎仪测的根本不是谎，是你紧不紧张
  'tip-025', // 不是越紧张表现越差—太放松也一样糟
  'tip-052', // 读得很顺骗了你—顺，不等于会
  'tip-031', // 心理学真正用来看人的，不是星座，是大五
  'tip-037', // 给你蜡烛、图钉、火柴，怎么把蜡烛固定在墙上、点着又不…
  'tip-008', // 潜意识广告能偷偷操控你购物—一个流传了大半个世纪的骗…
  'tip-045', // 多巴胺不是快乐分子，是想要分子 ·修正
  'tip-038', // 撞到桌角，为什么下意识揉一揉就没那么疼了
  'tip-042', // 开会前摆个‘大人物’姿势就能更自信—连原作者都不信了 ·修正
  'tip-024', // 被打击够了，人会连其实能逃都不去试
  'tip-017', // 临时抱佛脚，是最不划算的学法
  'tip-026', // 刚进电影院两眼一抹黑，几分钟后却能看清—眼睛在换挡
  'tip-034', // 对很小的婴儿来说，盖住的玩具就是真的消失了
  'cog-001', // 一串东西里，最先忘的偏偏是中间 ·认知
  'cog-008', // 能不能一心二用，不看你多聪明，看两件事像不像 ·认知
  'cog-002', // 电影是一格格静止的画面，你为什么看不见画面之间的黑？ ·认知
  'cog-009', // 为什么熟练之后，很多事你不用想就做了？ ·认知
  'cog-003', // 反复背没用—记得牢不牢，看你想得多深 ·认知
  'cog-007', // 你的大脑，其实一次只能接通一路信息 ·认知
  'cog-004'  // 记了好几分钟的东西，可能根本没存进脑子 ·认知
];
